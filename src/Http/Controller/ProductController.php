...
namespace TDP\Product\Http\Controller;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use App\Http\Controllers\Controller;

use TDP\Product\Models\Products;
use TDP\Product\Models\Product_Type;
use TDP\Product\Models\Accessories_PK;
use TDP\Product\Models\Images;
use TDP\Product\Models\PK_Product;
